...
def get_vacancy_list(prof_name: str, pn: int) -> list:
    ps = 0
    vacancy_list = []
    ...
    while True:
        ...
        for vacancy in vacancys:
            ...
            vacancy_info["prof_name"] = prof_name
            ...
            vacancy_info["source"] = "HH"
            hash_str = f'{vacancy_info["name"]}{ vacancy_info["link"]}{vacancy_info["employer_name"]}' \
                       f'{vacancy_info["employer_link"]}{vacancy_info["employer_address"]}' \
                       f'{prof_name}'
            #вычсляем HASH для первичного ключа в базе
            vacancy_info["_id"] = hashlib.sha1(hash_str.encode("utf-8")).hexdigest()
